 ...
 * @since 2024-09-25
 */
public interface SrmProjectClassMapper extends BaseMapper<SrmProjectClass> {
    IPage<ProjectClassVo> listProjectClass(@Param("page") Page<ProjectClassVo> page, @Param("projectClassDto") ProjectClassDto projectClassDto);
