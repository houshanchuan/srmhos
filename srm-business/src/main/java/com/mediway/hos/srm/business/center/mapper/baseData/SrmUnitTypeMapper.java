 ...
 * @since 2024-09-25
 */
public interface SrmUnitTypeMapper extends BaseMapper<SrmUnitType> {

    IPage<UnitTypeVo> listUnitType(@Param("page") Page<UnitTypeVo> page, @Param("unitTypeDto") UnitTypeDto unitTypeDto);
