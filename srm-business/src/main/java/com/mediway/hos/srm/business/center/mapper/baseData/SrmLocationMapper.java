 ...
 * @since 2024-09-25
 */
public interface SrmLocationMapper extends BaseMapper<SrmLocation> {
    IPage<LocationVo> listLocation(@Param("page") Page<LocationVo> page, @Param("locationDto") LocationDto locationDto);
