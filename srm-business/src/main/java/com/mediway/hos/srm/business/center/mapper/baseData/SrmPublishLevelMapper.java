 ...
 * @since 2024-09-25
 */
public interface SrmPublishLevelMapper extends BaseMapper<SrmPublishLevel> {
    IPage<PublishLevelVo> listPublishLevel(@Param("page") Page<PublishLevelVo> page, @Param("publishLevelDto") PublishLevelDto publishLevelDto);
