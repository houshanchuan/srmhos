 ...
 * @since 2024-09-25
 */
public interface SrmContractRoleMapper extends BaseMapper<SrmContractRole> {
    IPage<ContractRoleVo> listContractRole(@Param("page") Page<ContractRoleVo> page, @Param("contractRoleDto") ContractRoleDto contractRoleDto);
