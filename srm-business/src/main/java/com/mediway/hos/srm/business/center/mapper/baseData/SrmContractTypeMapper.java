 ...
 * @since 2024-09-25
 */
public interface SrmContractTypeMapper extends BaseMapper<SrmContractType> {
    IPage<ContractTypeVo> listContractType(@Param("page") Page<ContractTypeVo> page, @Param("contractTypeDto") ContractTypeDto contractTypeDto);
