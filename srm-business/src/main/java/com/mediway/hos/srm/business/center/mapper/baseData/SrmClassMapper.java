 ...
 * @since 2024-07-25
 */
public interface SrmClassMapper extends BaseMapper<SrmClass> {
    IPage<SubjectClassVo> listSubjectClass(@Param("page") Page<SubjectClassVo> page, @Param("subjectClassDto") SubjectClassDto subjectClassDto);
