 ...
 * @since 2024-09-25
 */
public interface SrmJournalTypeMapper extends BaseMapper<SrmJournalType> {
    List<CombVo> getJournalType();
    IPage<JournalTypeVo> listJournalType(@Param("page") Page<JournalTypeVo> page, @Param("journalTypeDto") JournalTypeDto journalTypeDto);
}
