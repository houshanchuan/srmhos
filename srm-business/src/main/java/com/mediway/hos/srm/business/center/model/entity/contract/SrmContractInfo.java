package com.mediway.hos.srm.business.center.model.entity.contract;
...
@ApiModel(value="SrmContractInfo对象", description="合同(项目)")
@TableName("srm_contract_info")
public class SrmContractInfo extends BasePO {
    ...
    @ApiModelProperty(value = "是否专利合同")
    @TableField("is_patent_contract")
    private Integer isPatentContract;
    @ApiModelProperty(value = "专利")
