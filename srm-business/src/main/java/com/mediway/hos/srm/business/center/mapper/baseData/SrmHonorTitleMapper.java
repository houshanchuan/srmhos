 ...
 * @since 2024-09-25
 */
public interface SrmHonorTitleMapper extends BaseMapper<SrmHonorTitle> {
    List<CombVo> getHonorTitle();

    IPage<HonorTitleVo> listHonorTitle(@Param("page") Page<HonorTitleVo> page, @Param("honorTitleDto") HonorTitleDto honorTitleDto);
